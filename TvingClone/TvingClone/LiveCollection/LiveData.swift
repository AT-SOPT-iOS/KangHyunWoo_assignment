...
extension LiveData {
    static func dummy() -> [LiveData] {
        return [
            ...
            LiveData(liveImg: .live3, rank : "3", broadcast: "TVN", title: "환승연애3", see: "8.5%"),
            LiveData(liveImg: .live4, rank : "4", broadcast: "TVN", title: "환승연애3", see: "7.5%"),
            LiveData(liveImg: .live5, rank : "5", broadcast: "TVN", title: "환승연애3", see: "6.5%")
        ]
    }
}
